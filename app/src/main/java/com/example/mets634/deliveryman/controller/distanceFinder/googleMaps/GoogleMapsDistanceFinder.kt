...
import com.example.mets634.deliveryman.controller.distanceFinder.TravelMode
import com.example.mets634.deliveryman.controller.distanceFinder.DistanceFinder
import com.example.mets634.deliveryman.controller.distanceFinder.DistanceType
...
object GoogleMapsDistanceFinder : DistanceFinder {
    ...
    override fun calcDistanceMatrix(
        ...
        Logger.d("""Calculating distance-matrix, with Google Maps, for:
            |Origins=$origins
